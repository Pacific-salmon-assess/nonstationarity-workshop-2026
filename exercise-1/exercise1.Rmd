...
static_sr_plot(data=df.ac,mod=ac.fit.ac,plot.params=TRUE,resids=TRUE) 
```
...
static_sr_plot(data=df.ac,mod=ac.fit.st,plot.params=TRUE,resids=TRUE) 
```
