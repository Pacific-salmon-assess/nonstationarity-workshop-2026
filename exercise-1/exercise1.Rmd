...
In real time-series of salmon spawner-recruit dynamics, we won't know what parameter is actually nonstationary (if any). Let's apply our estimates to the alternate simulation to see what it estimates (note - the simulation datasets are switched to be mismatched):
