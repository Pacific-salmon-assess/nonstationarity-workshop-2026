...
knitr::kable(data.frame("model" = c("autocorrelated", "static"), 
...
df.lin.prod=salmon_sim.tv(log.a0=log.a0,p.change=p.change,smax0=smax0,sigma=sigma,N=N,par="tv.par",form="tv.form")
...
knitr::kable(data.frame("model" = c("simulated", "estimated"), 
                        "AICc" = c(ns.prod.fit1$AICc, ns.smax.fit2$AICc), 
                        "AICc_weight" = model_weights(c(ns.prod.fit1$AICc,ns.smax.fit2$AICc),
                                                      form='TMB')), 
           digits = 2)
```
...
knitr::kable(data.frame("model" = c("simulated", "estimated"), 
                        "AICc" = c(ns.prod.fit2$AICc, ns.smax.fit1$AICc), 
                        "AICc_weight" = model_weights(c(ns.prod.fit2$AICc,ns.smax.fit1$AICc),form='TMB')), 
           digits = 2)
```
